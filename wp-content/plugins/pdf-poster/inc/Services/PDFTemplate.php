    ...
    public static function useLibrary(){
        ...
        <div id="<?php echo esc_attr(self::$uniqid); ?>" class="pdfp_wrapper <?php echo esc_attr(Functions::isset(self::$data['additional'], 'Class')) ?>" data-infos="<?php echo esc_attr(wp_json_encode(self::$data['infos'])) ?>">
            ...
            <div class="iframe_wrapper" >
                ...
                <iframe  id="<?php echo esc_attr("frame-".self::$uniqid); ?>" class="pdfp_iframe" width="<?php echo esc_attr($t['width']); ?>" height="<?php echo esc_attr($t['height']);?>" data-source="<?php echo esc_url($t['final_url']);?>&new" src="<?php echo esc_url($t['demo_url']);?>"></iframe>
            </div>
	    </div>
        <?php
    }
